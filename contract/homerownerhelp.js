...
const HomeownerSearchHelp = ({ findHomeOwner, searchHomeOwnerList, onSelect }) => {
    ...
    <View>
      ...
      <View style={styles.searchBox}>
        <TextInput
          ...
          onChangeText={(text) => {
            setSearchText(text);
            findHomeOwner(text); // Trigger search function
          }}
          value={searchText}
        />
...
export default HomeownerSearchHelp;
